...
class ProductModel {
  ...
  factory ProductModel.fromJson(Map<String, dynamic> json) => ProductModel(
        ...
        // crossSellIds: json['cross_sell_ids'] as List<String>?,
        // crossSellIds: List<String>.from(json['cross_sell_ids']),
        /// 用String的话会爆下面这个错误：
        /// type 'List<dynamic>' is not a subtype of type 'List<String>'
        /// 解决方案如下链接参考，上面也给了正确的示例
        /// https://stackoverflow.com/questions/64683313/type-listdynamic-is-not-a-subtype-of-type-liststring
        /// https://stackoverflow.com/questions/72375404/flutter-type-listdynamic-is-not-a-subtype-of-type-liststring
        /// https://stackoverflow.com/questions/69686611/flutter-listdynamic-is-not-a-subtype-of-type-liststring
        /// https://blog.csdn.net/codekxx/article/details/104557944
