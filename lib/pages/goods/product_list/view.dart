 ...
 * @LastEditTime: 2024-06-11 13:40:43
 * @FilePath: /flutter_woo_commerce_getx_learn/lib/pages/goods/product_list/view.dart
 * @Description: 
 */
...
class ProductListPage extends GetView<ProductListController> {
  ...
  Widget build(BuildContext context) {
    return GetBuilder<ProductListController>(
      ...
      builder: (_) {
        return Scaffold(
          appBar: mainAppBarWidget(titleString: controller.pageTitle),
          body: SmartRefresher(
